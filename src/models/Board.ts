...
export class Board {
  ...
  private addKnights() {
    new Knight(EColors.BLACK, this.getCell(1, 0));
    new Knight(EColors.BLACK, this.getCell(6, 0));
    new Knight(EColors.WHITE, this.getCell(1, 7));
    new Knight(EColors.WHITE, this.getCell(6, 7));
  }
